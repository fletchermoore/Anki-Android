...
import com.ichi2.fletcheranki.exception.StorageAccessException;
import com.ichi2.fletcheranki.services.BootService;
import com.ichi2.fletcheranki.services.NotificationService;
...
public class Preferences extends AppCompatPreferenceActivity implements PreferenceContext, OnSharedPreferenceChangeListener {
    ...
    public static Intent getPreferenceSubscreenIntent(Context context, String subscreen) {
        ...
        i.putExtra(PreferenceActivity.EXTRA_SHOW_FRAGMENT, "com.ichi2.fletcheranki.Preferences$SettingsFragment");
            ...
            case "com.ichi2.fletcheranki.prefs.reviewing":
                ...
                customButtonsPreference.setOnPreferenceClickListener(preference -> {
                    Intent i = getPreferenceSubscreenIntent(Preferences.this,
                            "com.ichi2.fletcheranki.prefs.custom_buttons");
                    startActivity(i);
                    return true;
                });
                break;
            case "com.ichi2.fletcheranki.prefs.appearance":
                listener.addPreferencesFromResource(R.xml.preferences_appearance);
                screen = listener.getPreferenceScreen();
                initializeCustomFontsDialog(screen);
                break;
            case "com.ichi2.fletcheranki.prefs.gestures":
                listener.addPreferencesFromResource(R.xml.preferences_gestures);
                break;
            case "com.ichi2.fletcheranki.prefs.custom_buttons":
                ...
                break;
            case "com.ichi2.fletcheranki.prefs.advanced":
                ...
                customSyncServerPreference.setOnPreferenceClickListener(preference -> {
                    Intent i = getPreferenceSubscreenIntent(Preferences.this,
                            "com.ichi2.fletcheranki.prefs.custom_sync_server");
                    startActivity(i);
                    return true;
                });
                ...
                advancedStatisticsPreference.setOnPreferenceClickListener(preference -> {
                    Intent i = getPreferenceSubscreenIntent(Preferences.this,
                            "com.ichi2.fletcheranki.prefs.advanced_statistics");
                    startActivity(i);
                    return true;
                });
                ...
                break;
            case "com.ichi2.fletcheranki.prefs.custom_sync_server":
                ...
                break;
            case "com.ichi2.fletcheranki.prefs.advanced_statistics":
        ...
        try {
            ...
            switch (key) {
                ...
                case "providerEnabled": {
                    ComponentName providerName = new ComponentName(this, "com.ichi2.fletcheranki.provider.CardContentProvider");
    ...
    public static class SettingsFragment extends android.preference.PreferenceFragment implements PreferenceContext, OnSharedPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            UsageAnalytics.sendAnalyticsScreenView(subscreen.replaceFirst("^com.ichi2.fletcheranki.", ""));
