...
package com.ichi2.fletcheranki.multimediacard.fields;
...
import com.ichi2.fletcheranki.multimediacard.activity.LoadPronounciationActivity;
import com.ichi2.fletcheranki.multimediacard.activity.PickStringDialogFragment;
import com.ichi2.fletcheranki.multimediacard.activity.TranslationActivity;
...
public class BasicTextFieldController extends FieldControllerBase implements IFieldController,
    ...
    /*
     * (non-Javadoc)
     * @see com.ichi2.fletcheranki.IFieldController#onActivityResult(int, int, android.content.Intent) When activity started
