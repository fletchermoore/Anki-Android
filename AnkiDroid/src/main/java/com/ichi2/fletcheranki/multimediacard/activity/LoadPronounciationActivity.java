...
import com.ichi2.fletcheranki.multimediacard.beolingus.parsing.BeolingusParser;
import com.ichi2.fletcheranki.multimediacard.language.LanguageListerBeolingus;
import com.ichi2.fletcheranki.runtimetools.TaskOperations;
import com.ichi2.fletcheranki.web.HttpFetcher;
...
public class LoadPronounciationActivity extends Activity implements OnCancelListener {
    ...
    // Must be passed in
    public static String EXTRA_SOURCE = "com.ichi2.fletcheranki.LoadPronounciationActivity.extra.source";
    // Passed out as a result
    public static String EXTRA_PRONUNCIATION_FILE_PATH = "com.ichi2.fletcheranki.LoadPronounciationActivity.extra.pronun.file.path";
